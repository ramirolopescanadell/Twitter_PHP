...
<body>
  ...
  <div class="muro muro_usuarios">
	<h1 class="h1_resultadosBusqueda"> Resultados de la busqueda </h1>
	  <div class="usuarios">
	    <div class="imagen2">
	   <img src="css/imagenes/marta.jpg" >
	   </div>
	   <a href="PerfilDeOtroUsuario.php" class="usuario_strong"> Marta Sanchez</a>
      <a href="#" class="usuario_seguir seguidosA"> <span class="icon-add-user"> Seguir </span> </a>
	   </div>
	  <div class="usuarios">
	   <div class="imagen2">
